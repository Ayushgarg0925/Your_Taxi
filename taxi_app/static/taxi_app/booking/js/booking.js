...
includeScript ('../taxi_app/booking/js/jquery-ui-1.10.3.custom.min.js');
includeScript ('../taxi_app/booking/js/jquery.fancyform.js');
includeScript ('../taxi_app/booking/js/jquery.placeholder.js');
includeScript ('../taxi_app/booking/js/regula.js');
